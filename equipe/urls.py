...
urlpatterns = [
    ...
    path('funcao/<int:pk>/', funcao_detail, name='funcao_detail'),
    path('<int:equipe_pk>/funcoes/adicionar/', funcao_create, name='funcao_create'),
    path('funcao/<int:pk>/editar/', funcao_update, name='funcao_update'),
    path('funcao/<int:pk>/excluir/', funcao_delete, name='funcao_delete'),
    ...
    path('membro/<int:pk>/', membros_equipe_detail, name='membros_equipe_detail'),
    path('<int:equipe_pk>/membro/adicionar/', membros_equipe_create, name='membros_equipe_create'),
    path('membro/<int:pk>/editar/', membros_equipe_update, name='membros_equipe_update'),
    path('membro/<int:pk>/excluir/', membros_equipe_delete, name='membros_equipe_delete'),
